                        ...
                        if($innerResult ->num_rows > 0)
                        {
                            ...
                            $get_poster_profile_email= $innerRow['email'];  
                             ...
                             $get_feed_image;
                                    ...
                                    echo "
                                        <center>
                                            <div style = 'margin-top:20px; height:600px;width:100%;border-radius:20px; padding:5px 15px 15px 10px;' class = 'bg-white'>
                                                    ...
                                                    <div style = 'width:100%'>
                                                        <img alt = 'icon' src = '$get_feed_image' style = 'width:88%;height:190px;border-radius:30px;'/>
